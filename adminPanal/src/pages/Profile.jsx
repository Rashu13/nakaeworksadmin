...
import { User, Package, Key, Lock, LogOut, Mail, Sun, Moon, Phone, CheckCircle, AlertCircle, Calendar, MapPin, Loader, Clock, Camera, Plus, Trash2, Edit2, X, Star, LayoutDashboard, FileText, Download, ChevronRight } from 'lucide-react';
...
const Profile = () => {
    ...
    const getStatusColor = (status) => {
        switch (status?.slug) {
            ...
            default: return 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-600 dark:text-gray-600 dark:text-gray-400';
        }
    };
                            ...
                            >
                                ...
                                {activeTab === 'dashboard' && (
                                    <div className="space-y-8">
                                        ...
                                        >
                                            ...
                                            <LayoutDashboard className="absolute -right-10 -bottom-10 w-64 h-64 text-slate-900 dark:text-slate-900 dark:text-white/5 group-hover:rotate-12 transition-transform duration-1000" />
                                        </motion.div>
                                                        ...
                                                        >
                                                            <div className="relative shrink-0">
                                                                <img
                                                                    ...
                                                                    className="w-20 h-20 rounded-2xl object-cover border border-gray-200 dark:border-gray-200 dark:border-white/10 group-hover:scale-105 transition-transform"
                                                                />
                                                                {booking.bookingStatus?.slug === 'completed' && (
                                                                    <div className="absolute -top-2 -right-2 bg-emerald-500 text-slate-900 dark:text-slate-900 dark:text-white p-1 rounded-full shadow-lg">
                                                                        <CheckCircle size={14} />
                                                                    </div>
                                                                )}
                                                            </div>
                                ...
                                {activeTab === 'profile' && (
                                    <div className="bg-white dark:bg-white dark:bg-slate-900/60 p-10 rounded-[2.5rem] border border-gray-200 dark:border-gray-200 dark:border-white/5 shadow-2xl relative overflow-hidden">
                                        ...
                                        <div className="mb-12 flex flex-col items-center sm:flex-row gap-10 p-8 rounded-3xl bg-gray-50 dark:bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-gray-200 dark:border-white/5 group">
                                            <div className="relative">
                                                <div className="w-32 h-32 rounded-[2.5rem] bg-gray-100 dark:bg-gray-100 dark:bg-slate-800 flex items-center justify-center overflow-hidden border-2 border-primary-500/30 group-hover:border-primary-500 transition-colors shadow-2xl">
                                                    {profile.avatar ? (
                                        ...
                                        <form onSubmit={handleProfileUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative group">
                                                    <Phone size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400 dark:text-gray-600 dark:text-gray-400 group-focus-within:text-primary-500 transition-colors" />
                                                    <input
                                                        type="tel"
                                                        value={profile.phone}
                                                ...
                                                {bookings.map((booking, i) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex flex-col sm:flex-row justify-between items-start gap-4 mb-6">
                                                                <div>
                                                                    ...
                                                                    <h3 className="text-2xl font-black text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight mb-2 group-hover:text-primary-500 transition-colors">{booking.service?.name}</h3>
                                                                ...
                                                                <span className={`px-5 py-2 rounded-xl text-[10px] font-black uppercase tracking-[2px] shadow-sm border border-gray-200 dark:border-gray-200 dark:border-white/5 ${getStatusColor(booking.bookingStatus)}`}>
                                                                    {booking.bookingStatus?.name || 'LOGGED'}
                                                                </span>
                                                            </div>

                                                            <div className="flex items-center gap-3 text-gray-500 dark:text-gray-400 dark:text-gray-600 dark:text-gray-400 text-xs font-bold p-4 bg-gray-50 dark:bg-gray-50 dark:bg-white/[0.03] rounded-2xl border border-gray-200 dark:border-gray-200 dark:border-white/5">
                                                        ...
                                                        <div className="flex flex-col justify-between items-center lg:items-end lg:border-l lg:pl-8 lg:border-gray-200 dark:border-gray-200 dark:border-white/5 gap-6">
                                                            ...
                                                            <button
                                                                onClick={() => handleViewDetails(booking)}
                                                                className="w-full lg:w-auto px-8 py-4 bg-primary-500 hover:bg-primary-600 text-slate-900 dark:text-slate-900 dark:text-white text-[10px] font-black uppercase tracking-widest rounded-2xl transition-all flex items-center justify-center gap-3 shadow-xl shadow-primary-500/10 group/btn"
                                                            >
                                                                ACCESS INTEL
                                                    ...
                                                    >
                                                        <div className="absolute top-6 right-6 flex gap-3 opacity-0 group-hover:opacity-100 transition-all translate-y-2 group-hover:translate-y-0">
                                                            <button
                                                                ...
                                                                className="p-2.5 bg-gray-200 dark:bg-gray-200 dark:bg-white/10 text-slate-900 dark:text-slate-900 dark:text-white hover:bg-primary-500 hover:text-slate-900 rounded-xl transition-all shadow-xl"
                                                            >
                                                                <Edit2 size={16} />
                                                            </button>
                                                            <button
                                                                onClick={() => confirmDeleteAddress(addr.id)}
                                                                className="p-2.5 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-slate-900 dark:text-slate-900 dark:text-white rounded-xl transition-all shadow-xl"
                                                            >
                                                                <Trash2 size={16} />
                                                            </button>
                                                        </div>
                                                        <div className="flex items-center gap-3 mb-6">
                                                            <div className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[2px] shadow-sm ${addr.type === 'home' ? 'bg-blue-500/10 text-blue-400 border border-blue-500/20' :
                                                                addr.type === 'work' ? 'bg-purple-500/10 text-purple-400 border border-purple-500/20' :
                                                                    'bg-gray-500/10 text-gray-600 dark:text-gray-600 dark:text-gray-400 border border-gray-500/20'
                                                                }`}>
                                                                {addr.type}
                                                            </div>
                                                        </div>
                                ...
                                {activeTab === 'security' && (
                                    <div className="bg-white dark:bg-white dark:bg-slate-900/60 rounded-[2.5rem] border border-gray-200 dark:border-gray-200 dark:border-white/5 p-10 shadow-2xl relative overflow-hidden">
                            ...
                            >
                                ...
                                <form onSubmit={handleAddressSubmit} className="space-y-6 relative z-10">
                                    ...
                                    <div className="flex items-center gap-3 p-4 bg-gray-100 dark:bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-gray-200 dark:border-white/10 rounded-2xl mb-4">
                                        ...
                                        />
                                        <label htmlFor="isPrimary" className="text-xs font-bold text-gray-600 dark:text-gray-600 dark:text-gray-400 uppercase tracking-widest cursor-pointer">Set as primary address</label>
                                    </div>
                        ...
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                            ...
                            >
                                ...
                                <div className="p-8 space-y-8">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            {selectedBooking.items && selectedBooking.items.length > 0 ? (
                                                ...
                                                <div className="flex gap-6 p-6 bg-gray-100 dark:bg-gray-100 dark:bg-white/5 rounded-3xl border border-gray-200 dark:border-gray-200 dark:border-white/10 relative overflow-hidden group">
                                                    ...
                                                    <img
                                                        ...
                                                        className="w-20 h-20 rounded-2xl object-cover border border-gray-200 dark:border-gray-200 dark:border-white/10 shadow-lg"
                                                    />
                                                    <div>
                                                        <h3 className="font-black text-xl text-slate-900 dark:text-slate-900 dark:text-white uppercase tracking-tight mb-1">{selectedBooking.service?.name}</h3>
                                            ...
                                            <div className="flex justify-center gap-3">
                                                {[1, 2, 3, 4, 5].map((star) => (
                                                    <button
                                                        ...
                                                        className={`transition-all transform hover:scale-110 ${reviewState.rating >= star ? 'text-primary-500' : 'text-slate-900 dark:text-slate-900 dark:text-white/10'}`}
                                                    >
                                    ...
                                    <button
                                        onClick={() => setShowBookingModal(false)}
                                        className="w-full py-4 bg-gray-100 dark:bg-gray-100 dark:bg-slate-800 text-slate-900 dark:text-slate-900 dark:text-white/50 font-black uppercase tracking-widest rounded-2xl hover:bg-slate-700 hover:text-slate-900 dark:text-slate-900 dark:text-white transition-all border border-gray-200 dark:border-gray-200 dark:border-white/5"
                                    >
                                        Exit Interface
                                    </button>
                                </div>
