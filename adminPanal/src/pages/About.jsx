            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Value 1 */}
                        <div className="bg-white dark:bg-white dark:bg-slate-900/40 p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-xl hover:-translate-y-2 transition-transform duration-300">
                        ...
                        <div className="bg-white dark:bg-white dark:bg-slate-900/40 p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-xl hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Fast Response</h3>
                            <p className="text-gray-600 dark:text-gray-400">Get your tasks done quickly with our streamlined booking and rapid dispatch system.</p>
                        </div>
                        {/* Value 3 */}
                        <div className="bg-white dark:bg-white dark:bg-slate-900/40 p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-xl hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">High Quality</h3>
                            <p className="text-gray-600 dark:text-gray-400">We guarantee satisfaction with a focus on meticulous attention to detail on every job.</p>
                        </div>
                        {/* Value 4 */}
                        <div className="bg-white dark:bg-white dark:bg-slate-900/40 p-8 rounded-3xl border border-gray-100 dark:border-white/5 shadow-xl hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <p className="text-gray-600 dark:text-gray-400">Our customer support team is always ready to assist you, ensuring a seamless experience.</p>
                        </div>
                    </div>
                </div>
            </div>
