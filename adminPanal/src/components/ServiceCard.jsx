                    ...
                    <div className="flex justify-between items-start gap-4">
                        <div>
                            <h3
                                ...
                                className="text-lg font-bold text-gray-900 dark:text-white hover:text-primary-500 cursor-pointer line-clamp-1 mb-1"
                            >
                                {name}
                            </h3>
                            <div className="flex items-center gap-2 text-sm">
                                <span className="font-bold text-gray-900 dark:text-primary-400 text-lg">₹{discountedPrice}</span>
                                {discount > 0 && (
        ...
        >
            ...
            <div className="p-4 flex flex-col flex-1">
                ...
                <div className="flex items-start justify-between gap-2 mb-3">
                    <h3
                        onClick={() => navigate(`/service/${service.slug || id}`)}
                        className="font-semibold text-gray-800 dark:text-white hover:text-primary-500 cursor-pointer line-clamp-2 flex-1 transition-colors"
                    >
                        {name}
                    </h3>
