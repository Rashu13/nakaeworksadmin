        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-400">Manage users and providers</p>
                </div>
                <button
                    onClick={() => openModal()}
                            ...
                            {loading ? (
                                ...
                                filteredUsers.map((user) => (
                                    <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${user.status === true ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'
                                                }`}>
            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-slate-800 rounded-2xl w-full max-w-md p-6 max-h-[90vh] overflow-y-auto border border-gray-100 dark:border-slate-700 shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex flex-col items-center mb-6">
                                <div className="relative">
                                    ...
                                    <label className="absolute bottom-0 right-0 p-1.5 bg-primary-600 text-white rounded-full cursor-pointer hover:bg-primary-700 transition-colors shadow-sm">
                                        <input
                                            type="file"
                                            className="hidden"
                                            accept="image/*"
                                ...
                                <p className="text-xs text-gray-500 mt-2">Allowed: JPG, PNG (Max 5MB)</p>
                            </div>
