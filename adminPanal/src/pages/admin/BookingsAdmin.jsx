                ...
                <div className="p-4 flex flex-col sm:flex-row gap-4">
                    ...
                    <div className="flex gap-2 relative">
                        <select
                            ...
                            className="px-4 py-2 bg-gray-50 dark:bg-slate-700 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none appearance-none pr-10 cursor-pointer text-sm font-medium text-gray-700 dark:text-gray-300"
                        >
                            ...
                            {!showProviderSelect ? (
                                ...
                                <div className="flex gap-2">
                                    <select
                                        ...
                                        className="flex-1 px-4 py-2 border border-gray-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none bg-white dark:bg-slate-700 text-gray-900 dark:text-white"
                                    >
